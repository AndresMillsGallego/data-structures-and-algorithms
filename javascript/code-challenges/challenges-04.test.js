...
const updateAnimal = (arr, upper) => {
  // Solution code here...
  // Both work I guess, though it was a bit confusing as I thought we needed to use both the above functions.
  // return arr.map(str => lower(str));
  return arr.map(str => upper(str));
};
...
const sortPeopleBetter = (arr) => {
  // Solution code here...
  // There is a cleaner way to write this, I started with Ternaries but that may be too confusing.
  return arr.sort((a, b) => {
...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
  // Full disclosure, I got the idea for this from Nina Scholz on stackoverflow.
