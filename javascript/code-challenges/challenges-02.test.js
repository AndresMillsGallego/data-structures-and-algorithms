...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let exponentArray = arr.map(num => Math.pow(num, 3));
...
const addOne = (arr) => {
  // Solution code here...
  let incrementedArray = arr.map(num => num +1);
...
const addQuestion = (arr) => {
  // Solution code here...
  let questionMarkArray = arr.map(string => string + '?');
...
const forLoopTwoToThe = (arr) => {
  ...
  // I did it this way too, with map.
  // let twoToTheArray = arr.map(num => Math.pow(2, num));
  // return twoToTheArray;

  let twoToTheArray = [];
  for (let num of arr) {
    let newNum = Math.pow(2, num);
    twoToTheArray.push(newNum);
  } return twoToTheArray;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let diffTwoToTheArray = [];
  arr.forEach(num => diffTwoToTheArray.push(Math.pow(2, num)));
  return diffTwoToTheArray;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  // oops, I did that above already on accident.  Will copy here.
  let mapTwoToTheArray = arr.map(num => Math.pow(2, num));
...
const charCode = (arr) => {
  // Solution code here...
  let charAtArray = arr.map(letter => letter.charCodeAt());
  return charAtArray;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let abilityNameArray = arr.map(ability => ability.ability.name);
