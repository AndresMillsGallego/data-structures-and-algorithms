...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce((totaledNums, num) => {return totaledNums + num;}, 0);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((totalAmount, price) => {return totalAmount + price.purchasePrice;}, 0);
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((totalEls, el) => {return el === el ? totalEls + 1 : totalEls;}, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  // Did Roger Huba write this? :)
  return arr.reduce((starryArray, name) => {
    starryArray.push(name.name);
    return starryArray;
  }, []);
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  return arr.reduce((kidTotal, kids) => {
    return kids.children ? kidTotal + kids.children.length : kidTotal;
  }, 0);
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce((primeCount, num) => {return isPrime(num) ? primeCount + 1 : primeCount;}, 0);
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  return arr.reduce((matchingName, obj) => {return obj.stat.name === statName ? matchingName + obj : matchingName;},{});
};
